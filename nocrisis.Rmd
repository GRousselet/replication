...
Now h = 0.1, so outliers are more likely than in the previous `g-and-h` simulation. Not surprisingly, replication success based on statistical significance gets worse when sampling from distributions with heavier tails.  
